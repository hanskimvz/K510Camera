...
links.Timeline.prototype.getScreenPositionX = function()
{
    var pageX = links.Timeline.getPageX(this.saveEvent);
    var x = pageX - links.Timeline.getAbsoluteLeft(this.dom.content);
    return x;
}