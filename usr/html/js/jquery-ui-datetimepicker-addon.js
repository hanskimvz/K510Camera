...
$.extend(Timepicker.prototype, {
	...
	_onTimeChange: function() {
		...
		if (hasChanged) {
			...
			if (timezone !== false) this.timezone = timezone;  // TODO(pau-climent): this should be based on the date.
...
$.datepicker._selectDate = function (id, dateStr) {
	...
	if (tp_inst) {
		...
		this._updateDatepicker(inst);  // TODO(pau-climent): timezone calc. here?
	}
